...
@section('content')
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="font-weight-bold text-primary">Detail Kuesioner Layanan Pembelajaran</h6>
    </div>
    <div class="card-body">
  ...
  <div class="card shadow mb-4">
    ...
    <form action="{{ route('pertanyaan.kemahasiswaan.store', ['kemahasiswaan' => $kemahasiswaan]) }}" method="post">
