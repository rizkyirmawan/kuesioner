        ...
        <div class="col-md-12">
          <table class="table table-bordered text-dark">
            ...
            <tr>
              ...
              <td>{{ $tracerStudy->respons->sum('jawaban.skor') <= 0 ? 0 : round($tracerStudy->respons->sum('jawaban.skor') / $tracerStudy->pertanyaan->where('tipe', '!=', 'Text')->where('tipe', '!=', 'Textarea')->count(), 1) }}</td>
            </tr>
          </table>
        </div>
